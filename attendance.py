...
window.configure(background='#1c06e1')
...
def trainImage():
    ...
    face, Ids = getImagesAndLabels("E:\STUDENT-ATTENDANCE\TrainingImages")
...
label1 = tk.Label(window, background="#1c06e1", fg="white", text="Name :", width=10, height=1,
                  font=('Helvetica', 16))
label1.place(x=83, y=40)
std_name = tk.Entry(window, background="#6176a5", fg="black", width=25, font=('Helvetica', 14))
std_name.place(x=280, y=41)
label2 = tk.Label(window, background="#1c06e1", fg="white", text="Enrollment No. :", width=14, height=1,
                  font=('Helvetica', 16))
label2.place(x=100, y=90)
std_number = tk.Entry(window, background="#6176a5", fg="black", width=25, font=('Helvetica', 14))
...
takeImageBtn = tk.Button(window, command=takeImage, background="blue", fg="white", text="REGISTER",
                         activebackground="pink",
                         width=15, height=3, font=('Helvetica', 12))
takeImageBtn.place(x=130, y=360)
trainImageBtn = tk.Button(window, command=trainImage, background="blue", fg="white", text="TRAIN IMAGE",
                          activebackground="pink",
                          width=15, height=3, font=('Helvetica', 12))
trainImageBtn.place(x=340, y=360)
trackImageBtn = tk.Button(window, command=trackImage, background="blue", fg="white", text="MARK ATTENDENCE", width=20,
